...
fun crearJugadores(): List<Jugador> {
    ...
    val jugadores: List<Jugador> = listOf(
        Jugador("Stanley Matthews", "Ingles", listOf(1956), 1, listOf(estad[0]), R.drawable.stanley_matthews_1956, R.drawable.inglaterra),
        Jugador("Alfredo Stéfano Di Stéfano Laulhé", "Argentino/Español", listOf(1957,1959), 2, listOf(estad[1],estad[3]), R.drawable.alfredo_di_stefano_1957, R.drawable.espana),
        Jugador("Raymond Kopaszewski", "Frences/Polaco", listOf(1958), 1, listOf(estad[2]), R.drawable.raymond_kopa_1958, R.drawable.francia),
        Jugador("Luis Suárez Miramontes", "Español", listOf(1960), 1, listOf(estad[4]), R.drawable.luis_suarez_1960, R.drawable.espana),
        Jugador("Enrique Omar Sívori", "Argentina/Italiana", listOf(1961), 1, listOf(estad[5]), R.drawable.omar_sivori_1961, R.drawable.italia),
        Jugador("Josef Masopust", "Republica Checa", listOf(1962), 1, listOf(estad[6]), R.drawable.josef_masopust_1962, R.drawable.republica_checa),
        Jugador("Lev Ivánovich Yashin", "Union Sovietica", listOf(1963), 1, listOf(estad[7]), R.drawable.lev_yashin_1963, R.drawable.urss),
        Jugador("Denis Law", "Escocés", listOf(1964), 1, listOf(estad[8]), R.drawable.denis_law_1964, R.drawable.escocia),
        Jugador("Eusébio da Silva Ferreira", "Portuguesa", listOf(1965), 1, listOf(estad[9]), R.drawable.eusebio_1965, R.drawable.portugal),
        Jugador("Robert Charlton", "Inglés", listOf(1966), 1, listOf(estad[10]), R.drawable.bobby_charlton_1966, R.drawable.inglaterra),
        Jugador("Flórián Albert", "Húngaro", listOf(1967), 1, listOf(estad[11]), R.drawable.florian_albert_1967, R.drawable.hungria),
        Jugador("George Best", "Norilandés", listOf(1968), 1, listOf(estad[12]), R.drawable.george_best_1968, R.drawable.irlanda_del_norte),
        Jugador("Giovanni Rivera", "Italiana", listOf(1969), 1, listOf(estad[13]), R.drawable.gianni_rivera_1969, R.drawable.italia),
        Jugador("Gerhard Müller", "Alemana", listOf(1970), 1, listOf(estad[14]), R.drawable.gerd_muller_1970, R.drawable.alemania),
        Jugador("Hendrik Johannes Cruijff", "Paises Bajos", listOf(1971,1973,1974), 3, listOf(estad[15],estad[17],estad[18]), R.drawable.johan_cruyff_1973,R.drawable.paises_bajos),
        Jugador("Franz Anton Beckenbauer", "aleman", listOf(1972,1976), 2, listOf(estad[16],estad[20]), R.drawable.franz_beckenbauer_1972,R.drawable.alemania),
        Jugador("Oleh Volodímirovich Blojín", "Union Sovietica", listOf(1975), 1, listOf(estad[19]), R.drawable.oleg_blokhin_1975,R.drawable.urss),
        Jugador("Allan Rodenkam Simonsen", "dinamarca", listOf(1977), 1, listOf(estad[21]), R.drawable.allan_simonsen_1977,R.drawable.dinamarca),
        Jugador("Joseph Kevin Keegan", "Ingles", listOf(1978,1979), 2, listOf(estad[22],estad[23]), R.drawable.kevin_keegan_1978, R.drawable.inglaterra),
        Jugador("Karl-Heinz Rummenigge", "aleman", listOf(1980,1981), 2, listOf(estad[24],estad[25]), R.drawable.karl_heinz_rummenigge_1980, R.drawable.alemania),
        Jugador("Paolo Rossi", "Italiana", listOf(1982), 1, listOf(estad[26]), R.drawable.paolo_sossi_1982, R.drawable.italia),
        Jugador("Michel François Platini", "Frances", listOf(1983,1984,1985), 3, listOf(estad[27],estad[28],estad[29]), R.drawable.michel_platini_1983, R.drawable.francia),
        Jugador("Íhor Ivánovich Belánov", "Union Sovietica", listOf(1986), 1, listOf(estad[30]), R.drawable.igor_belanov_1986, R.drawable.urss),
        Jugador("Ruud Gullit", "Paises Bajos", listOf(1987), 1, listOf(estad[31]), R.drawable.ruud_gullit_1987, R.drawable.paises_bajos),
        Jugador("Marcel van Basten ", "Paises Bajos", listOf(1988,1989,1992), 3, listOf(estad[32],estad[33],estad[36]), R.drawable.marco_van_basten_1988, R.drawable.paises_bajos),
        Jugador("Lothar Herbert Matthäus", "Aleman", listOf(1990), 1, listOf(estad[34]), R.drawable.lothar_matthaus_1990, R.drawable.alemania),
        Jugador("jean-Pierre Papin", "Frances", listOf(1991), 1, listOf(estad[35]), R.drawable.jean_pierre_papin_1991, R.drawable.francia),
        Jugador("Roberto Baggio", "Italiano", listOf(1993), 1, listOf(estad[37]), R.drawable.roberto_baggio_1993, R.drawable.italia),
        Jugador("Hristo Stoichkov", "bulgaro", listOf(1994), 1, listOf(estad[38]), R.drawable.hristo_stoichkov_1994, R.drawable.bulgaria),
        Jugador("George Tawlon Manneh Oppong Ousman Weah", "Liberia", listOf(1995), 1, listOf(estad[39]), R.drawable.george_weah_1995, R.drawable.liberia),
        Jugador("Matthias Sammer", "Aleman", listOf(1996), 1, listOf(estad[40]), R.drawable.matthias_sammer_1996, R.drawable.alemania),
        Jugador("Ronaldo Luís Nazário de Lima", "Brazileño", listOf(1997,2002), 2, listOf(estad[41],estad[46]), R.drawable.ronaldo_1997, R.drawable.brasil),
        Jugador("Zinedine Yazid Zidane", "Frances", listOf(1998), 1, listOf(estad[42]), R.drawable.zinedine_zidane_1998, R.drawable.francia),
        Jugador("Vítor Borba Ferreira Gomes", "Brazileño", listOf(1999), 1, listOf(estad[43]), R.drawable.rivaldo_1999, R.drawable.brasil),
        Jugador("Luís Filipe Madeira Caeiro Figo", "Portugal", listOf(2000), 1, listOf(estad[44]), R.drawable.luis_figo_2000, R.drawable.portugal),
        Jugador("Michael James Owen", "Ingles", listOf(2001), 1, listOf(estad[45]), R.drawable.michael_owen_2001, R.drawable.inglaterra),
        Jugador("Pavel Nedvěd", "Republica Checa", listOf(2003), 1, listOf(estad[47]), R.drawable.pavel_nedved_2003, R.drawable.republica_checa),
        Jugador("Andriy Mykolayovych Shevchenko", "Ucraniano", listOf(2004), 1, listOf(estad[48]), R.drawable.andrei_chevtchenko_2004, R.drawable.ucrania),
        Jugador("Ronaldo De Assis Moreira", "Brazileño", listOf(2005), 1, listOf(estad[49]), R.drawable.ronaldinho_2005, R.drawable.brasil),
